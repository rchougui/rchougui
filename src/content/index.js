export default {
  ...
  header: {
    img:
      process.env.PUBLIC_URL + '/assets/profilepic2.png',
    imgPlaceholder:
    ...
    text: ['Hi!', "I'm Riadh C.", 'Senior web dev./consultant'],
    typical: ['.', 60000],
  ...
  stack: {
    ...
    desc: `My skillset is formed mainly by strong knowledge of MongoDB/Express/React/Nodejs, and extends to attention to details, creativity, critical thinking, sense of initiative and problem solving. `,
  },
  contact: {
    title: 'Contact',
    desc:
      "With more than 10 years of experience, I'm a web developer with a perfect Upwork history feedback. Let's get in touch to work together on your next awesome web project.",
    socials: [
      {
        alt: 'gmail',
